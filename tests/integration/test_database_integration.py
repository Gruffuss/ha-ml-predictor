...
class TestDatabaseIntegration:
    ...
    async def test_sensor_event_crud_operations(self, test_db_session):
        ...
        result = await test_db_session.execute(
            select(SensorEvent).where(SensorEvent.sensor_id == "binary_sensor.integration_test")
        )
    ...
    async def test_room_state_tracking(self, test_db_session):
        ...
        history = await RoomState.get_occupancy_history(test_db_session, room_id, hours=4)
    ...
    async def test_feature_store_operations(self, test_db_session):
        ...
        features = [
            ...
            FeatureStore(
                ...
                temporal_features={"hour_sin": 0.0, "hour_cos": 1.0, "is_weekend": False},
            ...
            FeatureStore(
                ...
                temporal_features={"hour_sin": 0.707, "hour_cos": 0.707, "is_weekend": False},
            ...
            FeatureStore(
                ...
                temporal_features={"hour_sin": 0.866, "hour_cos": 0.5, "is_weekend": False},
        ...
        latest = await FeatureStore.get_latest_features(test_db_session, room_id, max_age_hours=6)
    ...
    async def test_time_series_queries(self, test_db_session):
        ...
        hourly_query = select(
            ...
            func.date_trunc('hour', SensorEvent.timestamp)
        ).order_by('hour')
        ...
        recent_query = select(SensorEvent).where(
            SensorEvent.room_id == room_id,
...
class TestDatabasePerformance:
    ...
    async def test_complex_query_performance(self, test_db_session):
        ...
        complex_query = select(
            ...
            func.sum(func.case((SensorEvent.state == 'on', 1), else_=0)).label('on_events'),
            func.avg(SensorEvent.confidence_score).label('avg_confidence'),

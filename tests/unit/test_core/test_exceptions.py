...
class TestDatabaseErrors:
    ...
    def test_database_connection_error(self):
        ...
        error = DatabaseConnectionError(
            "postgresql://user:password@localhost:5432/db", cause=cause
        )
    ...
    def test_database_query_error(self):
        ...
        error = DatabaseQueryError(
            "SELECT * FROM table", parameters={"id": 123}, cause=cause
        )
    ...
    def test_database_integrity_error(self):
        ...
        error = DatabaseIntegrityError(
            "unique_constraint", "users", values={"email": "test@example.com"}
        )
...
class TestModelErrors:
    ...
    def test_model_training_error(self):
        ...
        error = ModelTrainingError(
            "lstm", "living_room", cause=cause, training_data_size=100
        )
    ...
    def test_model_not_found_error(self):
        ...
        error = ModelNotFoundError(
            "lstm", "office", model_path="/models/office_lstm.pkl"
        )
    ...
    def test_insufficient_training_data_error(self):
        ...
        error = InsufficientTrainingDataError(
            "kitchen", data_points=50, minimum_required=100, time_span_days=7.5
        )
    ...
    def test_model_version_mismatch_error(self):
        ...
        error = ModelVersionMismatchError("ensemble", "bathroom", "1.0", "2.0")
...
class TestFeatureEngineeringErrors:
    ...
    def test_feature_extraction_error(self):
        ...
        error = FeatureExtractionError(
            "temporal", "bedroom", time_range="2024-01-01 to 2024-01-07", cause=cause
        )
    ...
    def test_feature_validation_error(self):
        ...
        error = FeatureValidationError(
            "temperature", "must be between -50 and 50", 75.5, room_id="office"
        )
    ...
    def test_missing_feature_error(self):
        ...
        error = MissingFeatureError(
            missing_features, "living_room", available_features=available_features
        )
...
class TestMQTTAndIntegrationErrors:
    ...
    def test_mqtt_connection_error(self):
        ...
        error = MQTTConnectionError(
            "mqtt.example.com", 1883, username="testuser", cause=cause
        )
    ...
    def test_mqtt_publish_error(self):
        ...
        error = MQTTPublishError(
            "occupancy/predictions/living_room", 1024, qos=1, cause=cause
        )
    ...
    def test_data_validation_error(self):
        ...
        error = DataValidationError(
            "Home Assistant", validation_errors, sample_data=sample_data
        )
    ...
    def test_rate_limit_exceeded_error(self):
        ...
        error = RateLimitExceededError(
            "Home Assistant API", 300, 3600, reset_time=1640995200
        )
...
class TestSystemErrors:
    ...
    def test_resource_exhaustion_error(self):
        ...
        error = ResourceExhaustionError(
            "memory", current_usage=1024.5, limit=1000.0, unit="MB"
        )
    ...
    def test_service_unavailable_error(self):
        ...
        error = ServiceUnavailableError(
            "Database", endpoint="postgresql://localhost:5432/db", retry_after=300
        )
...
class TestExceptionIntegration:
    ...
    def test_exception_chaining(self):
        ...
        chained_error = DatabaseConnectionError(
            "postgresql://localhost/db", cause=original_error
        )
    ...
    def test_severity_based_handling(self):
        ...
        assert (
            severity_levels[critical_error.severity]
            > severity_levels[high_error.severity]
        )
        assert (
            severity_levels[high_error.severity]
            > severity_levels[medium_error.severity]
        )

...
class TestTrainingProgress:
    ...
    def test_update_stage(self):
        ...
        progress.update_stage(
            TrainingStage.MODEL_TRAINING, {"models": ["lstm", "xgboost"]}
        )
...
class TestModelTrainingPipeline:
    ...
    def test_artifacts_path_creation(
        self,
        sample_training_config,
        mock_feature_engine,
        mock_feature_store,
    ...
    @pytest.mark.asyncio
    async def test_initial_training_success(
        self,
        sample_training_config,
        mock_feature_engine,
        mock_feature_store,
    ...
    @pytest.mark.asyncio
    async def test_initial_training_with_specific_rooms(
        self,
        sample_training_config,
        mock_feature_engine,
        mock_feature_store,
    ...
    @pytest.mark.asyncio
    async def test_retraining_with_full_retrain(
        self,
        sample_training_config,
        mock_feature_engine,
        mock_feature_store,
    ...
    async def test_train_room_models_success(
        ...
        with patch.object(
            ...
            pipeline, "_validate_data_quality"
        ) as mock_validate, patch.object(
            pipeline, "_extract_features_and_targets"
        ) as mock_extract, patch.object(
            pipeline, "_split_training_data"
        ) as mock_split, patch.object(
            pipeline, "_train_models"
        ) as mock_train, patch.object(
            pipeline, "_validate_models"
        ) as mock_validate_models, patch.object(
            pipeline, "_evaluate_and_select_best_model"
        ) as mock_evaluate, patch.object(
            pipeline, "_deploy_trained_models"
        ) as mock_deploy, patch.object(
            pipeline, "_cleanup_training_artifacts"
        ) as mock_cleanup:
    ...
    @pytest.mark.asyncio
    async def test_prepare_training_data(
        self,
        sample_training_config,
        mock_feature_engine,
        mock_feature_store,
    ...
    @pytest.mark.asyncio
    async def test_prepare_training_data_no_database(
        self, sample_training_config, mock_feature_engine, mock_feature_store
    ):
    ...
    @pytest.mark.asyncio
    async def test_validate_data_quality_good_data(
        self,
        sample_training_config,
        mock_feature_engine,
        mock_feature_store,
        ...
        good_data["timestamp"] = pd.date_range(
            datetime.now() - timedelta(hours=2), periods=200, freq="5min"
        )
    ...
    @pytest.mark.asyncio
    async def test_validate_data_quality_poor_data(
        self,
        sample_training_config,
        mock_feature_engine,
        mock_feature_store,
        ...
        poor_data = pd.DataFrame(
            {
                "timestamp": pd.date_range(
                    "2020-01-01", periods=10, freq="5min"
                ),  # Old data
    ...
    def test_can_proceed_with_quality_issues(
        self,
        sample_training_config,
        mock_feature_engine,
        mock_feature_store,
    ...
    @pytest.mark.asyncio
    async def test_extract_features_and_targets(
        self,
        sample_training_config,
        mock_feature_engine,
        mock_feature_store,
    ...
    @pytest.mark.asyncio
    async def test_extract_features_and_targets_empty_data(
        self,
        sample_training_config,
        mock_feature_engine,
        mock_feature_store,
...
class TestDataSplittingStrategies:
    ...
    @pytest.mark.asyncio
    async def test_time_series_split(
        self,
        sample_training_config,
        mock_feature_engine,
        mock_feature_store,
    ...
    @pytest.mark.asyncio
    async def test_expanding_window_split(
        self,
        sample_training_config,
        mock_feature_engine,
        mock_feature_store,
    ...
    @pytest.mark.asyncio
    async def test_rolling_window_split(
        self,
        sample_training_config,
        mock_feature_engine,
        mock_feature_store,
        ...
        assert (
            test_features.index[-1] == features_df.index[-1]
        )  # Test set uses most recent data

    @pytest.mark.asyncio
    async def test_holdout_split(
        self,
        sample_training_config,
        mock_feature_engine,
        mock_feature_store,
    ...
    @pytest.mark.asyncio
    async def test_split_insufficient_samples(
        self,
        sample_training_config,
        mock_feature_engine,
        mock_feature_store,
...
class TestModelTraining:
    ...
    @pytest.mark.asyncio
    async def test_train_models_ensemble(
        self,
        sample_training_config,
        mock_feature_engine,
        mock_feature_store,
    ...
    @pytest.mark.asyncio
    async def test_train_models_specific_type(
        self,
        sample_training_config,
        mock_feature_engine,
        mock_feature_store,
    ...
    @pytest.mark.asyncio
    async def test_train_models_failure(
        self,
        sample_training_config,
        mock_feature_engine,
        mock_feature_store,
    ...
    @pytest.mark.asyncio
    async def test_validate_models(
        self,
        sample_training_config,
        mock_feature_engine,
        mock_feature_store,
    ...
    @pytest.mark.asyncio
    async def test_evaluate_and_select_best_model(
        self,
        sample_training_config,
        mock_feature_engine,
        mock_feature_store,
        ...
        progress = TrainingProgress("test-123", TrainingType.INITIAL)
        trained_models = {
            "ensemble": mock_base_predictor,
            "xgboost": mock_base_predictor,
        }
    ...
    @pytest.mark.asyncio
    async def test_evaluate_and_select_best_model_empty_results(
        self,
        sample_training_config,
        mock_feature_engine,
        mock_feature_store,
    ...
    def test_meets_quality_thresholds(
        self,
        sample_training_config,
        mock_feature_engine,
        mock_feature_store,
    ...
    @pytest.mark.asyncio
    async def test_deploy_trained_models(
        self,
        sample_training_config,
        mock_feature_engine,
        mock_feature_store,
...
class TestModelArtifacts:
    ...
    @pytest.mark.asyncio
    async def test_save_model_artifacts(
        self,
        sample_training_config,
        mock_feature_engine,
        mock_feature_store,
    ...
    @pytest.mark.asyncio
    async def test_load_model_from_artifacts(
        self,
        sample_training_config,
        mock_feature_engine,
        mock_feature_store,
    ...
    @pytest.mark.asyncio
    async def test_load_model_from_artifacts_missing(
        self,
        sample_training_config,
        mock_feature_engine,
        mock_feature_store,
...
class TestPipelineManagement:
    ...
    @pytest.mark.asyncio
    async def test_get_model_performance_missing(
        self,
        sample_training_config,
        mock_feature_engine,
        mock_feature_store,
        ...
        performance = await pipeline.get_model_performance(
...
class TestTrainingIntegrationManager:
    ...
    @pytest.mark.asyncio
    async def test_integration_manager_initialize(
        self,
        mock_tracking_manager,
        sample_training_config,
        mock_feature_engine,
        ...
        with patch.object(
            integration_manager, "_start_background_tasks"
        ) as mock_tasks, patch.object(
            integration_manager, "_register_tracking_callbacks"
        ) as mock_callbacks:
    ...
    @pytest.mark.asyncio
    async def test_integration_manager_shutdown(
        self,
        mock_tracking_manager,
        sample_training_config,
        mock_feature_engine,
    ...
    @pytest.mark.asyncio
    async def test_on_accuracy_degradation(
        self,
        mock_tracking_manager,
        sample_training_config,
        mock_feature_engine,
        ...
        with patch.object(
            integration_manager, "_queue_retraining_request"
        ) as mock_queue:
    ...
    @pytest.mark.asyncio
    async def test_on_drift_detected(
        self,
        mock_tracking_manager,
        sample_training_config,
        mock_feature_engine,
    ...
    @pytest.mark.asyncio
    async def test_queue_retraining_request(
        self,
        mock_tracking_manager,
        sample_training_config,
        mock_feature_engine,
    ...
    def test_calculate_priority(
        ...
        assert (
            integration_manager._calculate_priority(30.0, 70.0) == 1
        )  # Critical (<50%)
    ...
    def test_get_cooldown_remaining(
        ...
        assert (
            remaining == 6.0
        )  # 12 hour cooldown - 6 hours elapsed = 6 hours remaining

    @pytest.mark.asyncio
    async def test_request_manual_training(
        self,
        mock_tracking_manager,
        sample_training_config,
        mock_feature_engine,
    ...
    def test_get_training_queue_status(
        self,
        mock_tracking_manager,
        sample_training_config,
        mock_feature_engine,
    ...
    def test_set_training_capacity(
        self,
        mock_tracking_manager,
        sample_training_config,
        mock_feature_engine,

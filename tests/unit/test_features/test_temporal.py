...
class TestTemporalFeatureExtractor:
    ...
    def test_extract_features_with_sample_data(self, extractor, sample_events, target_time):
        ...
        expected_features = [
            "time_since_last_event", "time_since_last_on", "time_since_last_off",
            "current_state_duration", "avg_on_duration", "hour_sin", "hour_cos",
            "is_weekend", "is_work_hours", "overall_activity_rate"
        ]
    ...
    def test_historical_patterns(self, extractor, sample_events, target_time):
        ...
        pattern_features = ["hour_activity_rate", "day_activity_rate", 
                          "overall_activity_rate", "similar_time_activity_rate"]
    ...
    def test_transition_timing_features(self, extractor, sample_events, target_time):
        ...
        features = extractor._extract_transition_timing_features(sample_events, target_time)
    ...
    def test_batch_feature_extraction(self, extractor, sample_events, target_time, room_states):
    ...
    def test_statistical_calculations_accuracy(self, extractor):
        ...
        assert abs(features["avg_on_duration"] - expected_on_duration) < 60.0  # Within 1 minute tolerance
    ...
    def test_feature_value_ranges(self, extractor, sample_events, target_time):
        ...
        time_features = ["time_since_last_event", "time_since_last_on", "time_since_last_off",
                        "current_state_duration", "avg_on_duration", "avg_off_duration"]
        ...
        rate_features = ["hour_activity_rate", "day_activity_rate", "overall_activity_rate",
                        "recent_occupancy_ratio", "avg_occupancy_confidence"]
        ...
        boolean_features = ["is_weekend", "is_work_hours", "is_sleep_hours",
                          "is_cold", "is_comfortable_temp", "is_warm"]
...
class TestTemporalFeatureExtractorEdgeCases:
    ...
    def test_rapid_state_changes(self, extractor):
        ...
        features = extractor.extract_features(events, target_time)
        assert isinstance(features, dict)
        assert features["recent_transition_rate"] > 0  # Should detect high transition rate

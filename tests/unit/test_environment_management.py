...
from src.core.environment import (
    Environment, EnvironmentManager, SecretsManager, EnvironmentSettings
)
...
class TestEnvironmentManager:
    ...
    def setup_method(self):
        ...
        self.env_manager = EnvironmentManager(
            ...
            secrets_dir=self.temp_secrets_dir
        )
...
class TestBackupManager:
    ...
    def test_database_backup_creation(self, mock_subprocess):
        ...
        backup_file = self.backup_manager.db_backup_manager.backup_dir / f"{backup_id}.sql.gz"

...
class TestTrainingProfiles:
    ...
    def test_training_profile_iteration(self):
        ...
        expected_values = ["development", "production", "testing", 
                          "research", "quick", "comprehensive"]
...
class TestTrainingConfigManager:
    ...
    def test_config_manager_initialization(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch('src.models.training_config.get_config') as mock_get_config:
                ...
                assert TrainingProfile.DEVELOPMENT.value in config_manager._environment_configs
                assert TrainingProfile.PRODUCTION.value in config_manager._environment_configs
                assert TrainingProfile.TESTING.value in config_manager._environment_configs
                assert TrainingProfile.RESEARCH.value in config_manager._environment_configs
                assert TrainingProfile.QUICK.value in config_manager._environment_configs
                assert TrainingProfile.COMPREHENSIVE.value in config_manager._environment_configs
    ...
    def test_default_profile_characteristics(self):
        ...
        with patch('src.models.training_config.get_config') as mock_get_config:
            ...
            dev_config = config_manager.get_environment_config(TrainingProfile.DEVELOPMENT)
            ...
            prod_config = config_manager.get_environment_config(TrainingProfile.PRODUCTION)
            ...
            research_config = config_manager.get_environment_config(TrainingProfile.RESEARCH)
            ...
            assert research_config.optimization_config.level == OptimizationLevel.INTENSIVE
    ...
    def test_profile_management(self):
        ...
        with patch('src.models.training_config.get_config') as mock_get_config:
            ...
            with pytest.raises(ValueError, match="Training profile invalid_profile not available"):
    ...
    def test_training_config_generation(self):
        ...
        with patch('src.models.training_config.get_config') as mock_get_config:
            ...
            training_config = config_manager.get_training_config(TrainingProfile.DEVELOPMENT)
            ...
            assert training_config.enable_hyperparameter_optimization is False  # Development setting
            assert training_config.save_intermediate_results is True  # Not testing profile
    ...
    def test_configuration_validation(self):
        ...
        with patch('src.models.training_config.get_config') as mock_get_config:
            ...
            for profile in TrainingProfile:
                ...
                assert len(issues) == 0, f"Profile {profile.value} has validation issues: {issues}"
    ...
    def test_optimization_config_retrieval(self):
        ...
        with patch('src.models.training_config.get_config') as mock_get_config:
            ...
            dev_opt = config_manager.get_optimization_config(TrainingProfile.DEVELOPMENT)
            prod_opt = config_manager.get_optimization_config(TrainingProfile.PRODUCTION)
            research_opt = config_manager.get_optimization_config(TrainingProfile.RESEARCH)
            ...
            assert research_opt.max_optimization_time_minutes > prod_opt.max_optimization_time_minutes
    ...
    def test_profile_updates(self):
        ...
        with patch('src.models.training_config.get_config') as mock_get_config:
            ...
            # Get initial value
            initial_config = config_manager.get_environment_config(TrainingProfile.DEVELOPMENT)
            ...
            # Verify update
            updated_config = config_manager.get_environment_config(TrainingProfile.DEVELOPMENT)
...
class TestConfigurationIntegration:
    ...
    def test_training_config_to_pipeline_integration(self):
        ...
        with patch('src.models.training_config.get_config') as mock_get_config:
            ...
            assert dev_config.max_training_time_minutes < prod_config.max_training_time_minutes
    ...
    def test_profile_resource_mapping(self):
        ...
        with patch('src.models.training_config.get_config') as mock_get_config:
            ...
            prod_training = config_manager.get_training_config(TrainingProfile.PRODUCTION)
            
            assert prod_training.max_training_time_minutes == prod_env.resource_limits.max_training_time_minutes
            assert prod_training.max_parallel_models == prod_env.resource_limits.max_parallel_models
            assert prod_training.memory_limit_gb == prod_env.resource_limits.max_memory_gb
            assert prod_training.cpu_cores == prod_env.resource_limits.max_cpu_cores
            
            # Test quality threshold mapping
            assert prod_training.min_accuracy_threshold == prod_env.quality_thresholds.min_accuracy_threshold
            assert prod_training.max_error_threshold_minutes == prod_env.quality_thresholds.max_error_threshold_minutes
            assert prod_training.min_samples_per_room == prod_env.quality_thresholds.min_samples_per_room
            
            # Test optimization mapping
            assert prod_training.enable_hyperparameter_optimization == prod_env.optimization_config.enabled
...
class TestStructuredFormatter:
    ...
    def test_format_with_complex_message(self):
        ...
        assert (
            'Complex message with "quotes", newlines\n, and unicode: ñoño'
            in parsed["message"]
        )
...
class TestPerformanceLogger:
    ...
    def test_log_prediction_accuracy(self):
        ...
        with patch.object(perf_logger.logger, "info") as mock_info:
            perf_logger.log_prediction_accuracy("kitchen", 12.5, 0.92, "next_vacant")
    ...
    def test_log_model_metrics(self):
        ...
        metrics = {"r2_score": 0.85, "mae": 8.5, "rmse": 12.3}
...
class TestErrorTracker:
    ...
    def test_track_error_with_context(self):
        ...
        with patch.object(error_tracker.logger, "error") as mock_error:
            error_tracker.track_error(
                error, context=context, severity="warning", alert=True
            )
    ...
    def test_track_data_error(self):
        ...
        with patch.object(error_tracker.logger, "error") as mock_error:
            error_tracker.track_data_error(error, "home_assistant", "sensor.motion_1")
    ...
    def test_track_integration_error(self):
        ...
        with patch.object(error_tracker.logger, "error") as mock_error:
            error_tracker.track_integration_error(error, "mqtt", "mqtt://broker:1883")
...
class TestMLOperationsLogger:
    ...
    def test_log_model_deployment(self):
        ...
        with patch.object(ml_logger.logger, "info") as mock_info:
            ml_logger.log_model_deployment("patio", "svm", "v2.1", performance_metrics)
...
class TestLoggerManager:
    ...
    def test_setup_logging_config_exists(self):
        ...
        try:
            with patch("logging.config.dictConfig") as mock_dict_config, patch(
                "pathlib.Path.mkdir"
            ) as mock_mkdir:
    ...
    def test_setup_logging_config_error(self):
        ...
        try:
            with patch("logging.basicConfig") as mock_basic_config, patch(
                ...
                assert (
                    "Failed to load logging configuration" in mock_print.call_args[0][0]
                )
    ...
    def test_setup_logging_adds_json_formatter_to_file_handlers(self):
        ...
        try:
            with patch("logging.config.dictConfig") as mock_dict_config, patch(
                ...
                assert (
                    config_used["handlers"]["console_handler"]["formatter"] == "simple"
                )
        ...
        with patch.object(LoggerManager, "_setup_logging"):
            ...
            with patch("logging.getLogger") as mock_get_logger:
                ...
                mock_get_logger.assert_called_once_with(
                    "occupancy_prediction.test_module"
                )
    ...
    def test_log_operation_context_manager_success(self):
        ...
        with patch.object(manager, "get_logger") as mock_get_logger, patch.object(
            manager.performance_logger, "log_operation_time"
        ) as mock_log_time, patch(
    ...
    def test_log_operation_context_manager_with_exception(self):
        ...
        with patch.object(manager, "get_logger") as mock_get_logger, patch.object(
            manager.error_tracker, "track_error"
        ) as mock_track_error, patch(
            "time.time", side_effect=[1000.0, 1001.5]
        ):  # 1.5 second before error
    ...
    def test_log_operation_context_manager_no_room_id(self):
        ...
        with patch.object(manager, "get_logger") as mock_get_logger, patch.object(
            manager.performance_logger, "log_operation_time"
        ) as mock_log_time, patch("time.time", side_effect=[1000.0, 1001.0]):
...
class TestLoggerEdgeCases:
    ...
    def test_performance_logger_with_none_values(self):
        ...
        with patch.object(perf_logger.logger, "info") as mock_info:
            perf_logger.log_operation_time(
                "test", 1.0, room_id=None, prediction_type=None
            )
    ...
    def test_log_operation_zero_duration(self):
        ...
        with patch.object(manager, "get_logger") as mock_get_logger, patch.object(
            ...
            "time.time", side_effect=[1000.0, 1000.0]

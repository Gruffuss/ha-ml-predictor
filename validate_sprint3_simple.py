...
def check_file_contents():
    ...
    checks = {
        ...
        "PredictionResult class": ("src/models/base/predictor.py", "class PredictionResult"),
        "TrainingResult class": ("src/models/base/predictor.py", "class TrainingResult"),
        "LSTMPredictor class": ("src/models/base/lstm_predictor.py", "class LSTMPredictor"),
        "XGBoostPredictor class": ("src/models/base/xgboost_predictor.py", "class XGBoostPredictor"),
        "HMMPredictor class": ("src/models/base/hmm_predictor.py", "class HMMPredictor"),
        "OccupancyEnsemble class": ("src/models/ensemble.py", "class OccupancyEnsemble"),
        ...
        try:
            if full_path.exists():
                ...
                if f"class {class_name}({base_class})" in content:
                    ...
                    print(f"  [FAIL] {class_name} does not properly inherit from {base_class}")
            else:
                failed_inheritance.append(class_name)

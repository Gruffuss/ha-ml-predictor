...
def test_optimizer_imports():
    ...
    try:
        ...
        print(
            f"  ✅ ModelOptimizer instantiated with {len(optimizer._parameter_spaces)} parameter spaces"
        )
...
def test_configuration_structure():
    ...
    try:
        ...
        print(
            f"  ✅ Configuration structure defined: {len(config_structure)} optimization settings"
        )
        ...
        print(
            f"  ✅ Strategy validation passed: {config_structure['optimization_strategy']}"
        )

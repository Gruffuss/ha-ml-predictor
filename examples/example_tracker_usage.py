...
async def demo_real_time_tracking():
    ...
    tracker = AccuracyTracker(
        ...
        notification_callbacks=[alert_notification_callback, sync_notification_callback]
    )
    ...
    try:
        ...
        for i in range(5):
            ...
            actual_time = current_time + timedelta(minutes=30 + (i * 5))  # Increasing error
        ...
        if global_metrics:
            ...
            print(f"Overall Health Score: {global_metrics.overall_health_score:.1f}/100")
        ...
        if room_metrics:
            ...
            metrics_dict = room_metrics.to_dict() if hasattr(room_metrics, 'to_dict') else room_metrics
        ...
        if trends.get('trends_by_entity'):
            ...
            for entity, trend_data in trends['trends_by_entity'].items():
                print(f"{entity}: {trend_data.get('direction', 'unknown')} "

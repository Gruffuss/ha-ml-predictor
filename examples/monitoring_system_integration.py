...
from src.adaptation.monitoring_enhanced_tracking import create_monitoring_enhanced_tracking_manager
...
async def demonstrate_monitoring_integration():
    ...
    print(f"   Metrics Collection: {'✅ Enabled' if status['monitoring']['metrics_collection']['enabled'] else '❌ Disabled'}")
    ...
    prediction_metrics = [line for line in metrics_lines if 'occupancy_predictor_predictions_total' in line and not line.startswith('#')]

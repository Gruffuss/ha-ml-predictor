...
class MonitoringIntegration:
    ...
    @asynccontextmanager
    async def track_prediction_operation(
        self, room_id: str, prediction_type: str, model_type: str
    ):
    ...
    @asynccontextmanager
    async def track_training_operation(
        self, room_id: str, model_type: str, training_type: str
    ):
        ...
        try:
            ...
            await self.alert_manager.handle_model_training_error(
                error=e, room_id=room_id, model_type=model_type
            )

...
class MLMetricsCollector:
    ...
    def record_prediction(self, room_id: str, prediction_type: str,
                         model_type: str, duration: float,
    ...
    def record_model_training(self, room_id: str, model_type: str,
                            training_type: str, duration: float,
    ...
    def record_concept_drift(self, room_id: str, drift_type: str,
        ...
        self.drift_severity_score.labels(
            room_id=room_id,
            drift_type=drift_type
        ).set(severity)
    ...
    def record_event_processing(self, room_id: str, sensor_type: str,
    ...
    def record_feature_computation(self, room_id: str, feature_type: str,
                                 duration: float):
    ...
    def record_mqtt_publish(self, topic_type: str, room_id: str,
                          status: str = 'success'):
    ...
    def update_ha_connection_status(self, connection_type: str, connected: bool):
        ...
        self.ha_connection_status.labels(
    ...
    def update_active_models_count(self, room_id: str, model_type: str, count: int):
        ...
        self.active_models_count.labels(
            room_id=room_id,
            model_type=model_type
        ).set(count)
    ...
    def update_prediction_queue_size(self, queue_type: str, size: int):
        ...
        self.prediction_queue_size.labels(

...
from src.core.exceptions import (
    DatabaseConnectionError, DatabaseQueryError, ErrorSeverity
)
    ...
    def _setup_connection_events(self) -> None:
        ...
        def on_connect(dbapi_connection, connection_record):
            ...
            logger.debug(
                ...
                extra={'total_connections': self._connection_stats['total_connections']}
            )
            ...
            async with self.get_session() as session:
                ...
                if self._connection_stats['last_connection_error']:
                    health_status['errors'].append({
                        ...
                        'failed_count': self._connection_stats['failed_connections']
                    })

...
class AuthUser(BaseModel):
    ...
    def validate_permissions(cls, v):
        ...
        valid_permissions = {
            "read", "write", "admin", "model_retrain", "system_config",
            "prediction_view", "accuracy_view", "health_check"
        }
...
class LogoutRequest(BaseModel):
    ...
    revoke_all_tokens: bool = Field(False, description="Whether to revoke all user tokens")
